...
\begin{figure}[b]
\centering
\includegraphics[width=0.85\textwidth]{graphics/goodandbadapprox.eps}
...
\begin{frame}{Intuitivamente, in $\RR^2$, $d=1$}
\begin{center}
  ...
  % Text Node
  \draw (313,230) node [anchor=north west][inner sep=0.75pt]    {$after\ k\ steps$};
  % Text Node
...
\draw [color={rgb, 255:red, 208; green, 2; blue, 27}  ,draw opacity=1 ][line width=1.5]    (219.5,39.5) -- (234.75,160.5) ;
...
\begin{center}
  \tikzset{every picture/.style={line width=0.75pt}} %set default line width to 0.75pt        
  \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-0.625,xscale=0.625]
  %uncomment if require: \path (0,300); %set diagram left start at 0, and has height of 300
  ...
  \draw [color={rgb, 255:red, 208; green, 2; blue, 27}  ,draw opacity=1 ][line width=1.5]    (358.25,40) -- (370.03,133.5) ;
  ...
  \draw [color={rgb, 255:red, 208; green, 2; blue, 27}  ,draw opacity=1 ][line width=1.5]    (256.6,84.28) -- (268.38,177.78) ;
  ...
  \draw [color={rgb, 255:red, 208; green, 2; blue, 27}  ,draw opacity=1 ][line width=1.5]    (136.75,36.5) -- (148.53,130) ;
  ...
  \draw [color={rgb, 255:red, 208; green, 2; blue, 27}  ,draw opacity=1 ][line width=1.5]    (35.1,80.78) -- (46.89,174.28) ;
...
\begin{figure}[b]
\centering
\includegraphics[width=0.52\textwidth]{graphics/algorithm.eps}
\end{figure}
...
\begin{figure}[b]
\centering
\includegraphics[width=0.95\textwidth]{graphics/scurve.eps}
\end{figure}
\end{frame}
...
\begin{figure}[b]
\centering
\includegraphics[width=0.5\textwidth]{graphics/rec_sub0_vt.eps}
\end{figure}
\end{frame}
...
\begin{figure}[b]
\centering
\includegraphics[width=0.55\textwidth]{graphics/cluster_sub0.eps}
\end{figure}
\end{frame}
...
\begin{figure}[b]
\centering
\includegraphics[width=0.5\textwidth]{graphics/vidtimit_sub1_rec.eps}
\end{figure}
\end{frame}
...
\begin{figure}[b]
\centering
\includegraphics[width=0.55\textwidth]{graphics/vidtimit_cluster_sub1.eps}
\end{figure}
\end{frame}
