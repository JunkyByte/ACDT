...
\begin{frame}{Intuitivamente, in $\RR^2$}
\begin{center}
...
\begin{definition}[Punto medio di Karcher su $G_{N,d}(\RR^{N})$ rispetto $D_T$]
...
\begin{definition}[Predicato di $\it{Validità}$]
...
\begin{definition}[Predicato di $\it{Fondibilità}$ (informale)]
